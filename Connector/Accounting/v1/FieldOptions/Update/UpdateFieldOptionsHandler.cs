...
namespace Connector.Accounting.v1.FieldOptions.Update;

public class UpdateFieldOptionsHandler : IActionHandler<UpdateFieldOptionsAction>
{
    private readonly ILogger<UpdateFieldOptionsHandler> _logger;

    public UpdateFieldOptionsHandler(
        ILogger<UpdateFieldOptionsHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateFieldOptionsActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateFieldOptionsActionOutput>();
            ...
            // var resource = new UpdateFieldOptionsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateFieldOptionsHandler" };
