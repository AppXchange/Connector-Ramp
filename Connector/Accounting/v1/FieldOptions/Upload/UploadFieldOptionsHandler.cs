...
namespace Connector.Accounting.v1.FieldOptions.Upload;

public class UploadFieldOptionsHandler : IActionHandler<UploadFieldOptionsAction>
{
    private readonly ILogger<UploadFieldOptionsHandler> _logger;

    public UploadFieldOptionsHandler(
        ILogger<UploadFieldOptionsHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UploadFieldOptionsActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UploadFieldOptionsActionOutput>();
            ...
            // var resource = new UploadFieldOptionsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UploadFieldOptionsHandler" };
