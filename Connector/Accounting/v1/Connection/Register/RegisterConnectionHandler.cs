...
public class RegisterConnectionHandler : IActionHandler<RegisterConnectionAction>
{
    private readonly ILogger<RegisterConnectionHandler> _logger;

    public RegisterConnectionHandler(
        ILogger<RegisterConnectionHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<RegisterConnectionActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<RegisterConnectionActionOutput>();
            ...
            // var resource = new RegisterConnectionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "RegisterConnectionHandler" };
