...
public class DeleteAccountHandler : IActionHandler<DeleteAccountAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeleteAccountActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeleteAccountActionOutput>();
            ...
            // var resource = new DeleteAccountActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteAccountHandler" };
