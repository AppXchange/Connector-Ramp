...
public class DeleteFieldHandler : IActionHandler<DeleteFieldAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeleteFieldActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeleteFieldActionOutput>();
            ...
            // var resource = new DeleteFieldActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteFieldHandler" };
