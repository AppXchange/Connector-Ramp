...
namespace Connector.Accounting.v1.Vendors.Upload;

public class UploadVendorsHandler : IActionHandler<UploadVendorsAction>
{
    private readonly ILogger<UploadVendorsHandler> _logger;

    public UploadVendorsHandler(
        ILogger<UploadVendorsHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UploadVendorsActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UploadVendorsActionOutput>();
            ...
            // var resource = new UploadVendorsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UploadVendorsHandler" };
