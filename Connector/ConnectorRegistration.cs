namespace Connector;
using Connector.Accounting.v1;
using Connector.Client;
using Connector.Connections;
using Connector.Core.v1;
using ESR.Hosting;
...
public class ConnectorRegistration : IConnectorRegistration<ConnectorRegistrationConfig>, IConfigureConnectorApiClient
{
    ...
    {
        serviceCollection.AddSingleton<IConnectorServiceDefinition, AccountingV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, AccountingV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, CoreV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, CoreV1CacheWriterServiceDefinition>();
    }
