...
public class ReactivateUserHandler : IActionHandler<ReactivateUserAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<ReactivateUserActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<ReactivateUserActionOutput>();
            ...
            // var resource = new ReactivateUserActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "ReactivateUserHandler" };
