...
public class DeactivateUserHandler : IActionHandler<DeactivateUserAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeactivateUserActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeactivateUserActionOutput>();
            ...
            // var resource = new DeactivateUserActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeactivateUserHandler" };
