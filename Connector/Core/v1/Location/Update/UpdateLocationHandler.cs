...
namespace Connector.Core.v1.Location.Update;

public class UpdateLocationHandler : IActionHandler<UpdateLocationAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateLocationActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateLocationActionOutput>();
            ...
            // var resource = new UpdateLocationActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateLocationHandler" };
