...
namespace Connector.Core.v1.Card.Suspend;

public class SuspendCardHandler : IActionHandler<SuspendCardAction>
{
    private readonly ILogger<SuspendCardHandler> _logger;

    public SuspendCardHandler(
        ILogger<SuspendCardHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<SuspendCardActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<SuspendCardActionOutput>();
            ...
            // var resource = new SuspendCardActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "SuspendCardHandler" };
