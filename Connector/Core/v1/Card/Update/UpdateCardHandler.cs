...
namespace Connector.Core.v1.Card.Update;

public class UpdateCardHandler : IActionHandler<UpdateCardAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateCardActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateCardActionOutput>();
            ...
            // var resource = new UpdateCardActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCardHandler" };
