...
namespace Connector.Core.v1.Card.Unlock;

public class UnlockCardHandler : IActionHandler<UnlockCardAction>
{
    private readonly ILogger<UnlockCardHandler> _logger;

    public UnlockCardHandler(
        ILogger<UnlockCardHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UnlockCardActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UnlockCardActionOutput>();
            ...
            // var resource = new UnlockCardActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UnlockCardHandler" };
