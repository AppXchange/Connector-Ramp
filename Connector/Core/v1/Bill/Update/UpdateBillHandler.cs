...
namespace Connector.Core.v1.Bill.Update;

public class UpdateBillHandler : IActionHandler<UpdateBillAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateBillActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateBillActionOutput>();
            ...
            // var resource = new UpdateBillActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateBillHandler" };
