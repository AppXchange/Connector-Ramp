...
namespace Connector.Core.v1.Bill.Delete;

public class DeleteBillHandler : IActionHandler<DeleteBillAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeleteBillActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeleteBillActionOutput>();
            ...
            // var resource = new DeleteBillActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteBillHandler" };
