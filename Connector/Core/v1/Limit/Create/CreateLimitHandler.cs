...
namespace Connector.Core.v1.Limit.Create;

public class CreateLimitHandler : IActionHandler<CreateLimitAction>
{
    private readonly ILogger<CreateLimitHandler> _logger;

    public CreateLimitHandler(
        ILogger<CreateLimitHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<CreateLimitActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<CreateLimitActionOutput>();
            ...
            // var resource = new CreateLimitActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateLimitHandler" };
