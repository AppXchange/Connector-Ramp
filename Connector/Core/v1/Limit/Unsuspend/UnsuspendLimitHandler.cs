...
namespace Connector.Core.v1.Limit.Unsuspend;

public class UnsuspendLimitHandler : IActionHandler<UnsuspendLimitAction>
{
    private readonly ILogger<UnsuspendLimitHandler> _logger;

    public UnsuspendLimitHandler(
        ILogger<UnsuspendLimitHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UnsuspendLimitActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UnsuspendLimitActionOutput>();
            ...
            // var resource = new UnsuspendLimitActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UnsuspendLimitHandler" };
