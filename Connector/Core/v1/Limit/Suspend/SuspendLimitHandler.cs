...
namespace Connector.Core.v1.Limit.Suspend;

public class SuspendLimitHandler : IActionHandler<SuspendLimitAction>
{
    private readonly ILogger<SuspendLimitHandler> _logger;

    public SuspendLimitHandler(
        ILogger<SuspendLimitHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<SuspendLimitActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<SuspendLimitActionOutput>();
            ...
            // var resource = new SuspendLimitActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "SuspendLimitHandler" };
