...
namespace Connector.Core.v1.Limit.Update;

public class UpdateLimitHandler : IActionHandler<UpdateLimitAction>
{
    private readonly ILogger<UpdateLimitHandler> _logger;

    public UpdateLimitHandler(
        ILogger<UpdateLimitHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateLimitActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateLimitActionOutput>();
            ...
            // var resource = new UpdateLimitActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateLimitHandler" };
