...
public class UpdateDepartmentHandler : IActionHandler<UpdateDepartmentAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // response = await _apiClient.PostDepartmentDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetDepartmentDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateDepartmentActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateDepartmentHandler" };
