...
namespace Connector.Core.v1.SharedLimit.AddUsers;

public class AddUsersSharedLimitHandler : IActionHandler<AddUsersSharedLimitAction>
{
    private readonly ILogger<AddUsersSharedLimitHandler> _logger;

    public AddUsersSharedLimitHandler(
        ILogger<AddUsersSharedLimitHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<AddUsersSharedLimitActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<AddUsersSharedLimitActionOutput>();
            ...
            // var resource = new AddUsersSharedLimitActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "AddUsersSharedLimitHandler" };
